...
checkinstall -D -y \
	...
	--provides=agenda \
	--requires="akonadi-server,libc6,libkf5akonadicore5,libkf5akonadicontact5,libkf5calendarsupport5,libkf5coreaddons5,libkf5eventviews5,libkf5i18n5,libkf5kiocore5,libqt5core5a,libqt5gui5,libqt5qml5,libqt5sql5,libqt5widgets5,mauikit-calendar-git \(\>= 3.0.0+git\),mauikit-git \(\>= 3.0.0+git\)" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
